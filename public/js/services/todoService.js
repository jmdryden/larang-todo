// This is an example of a module. this is injected later in our main module to become usable
var app = angular.module('todoService', []);

//** use http service to facilitate communication with the remote http servers via the browser's 
